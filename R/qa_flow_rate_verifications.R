...
#'
#'@name qa_flow_rate_verifications
NULL

#'@rdname qa_flow_rate_verifications
#'@export
qa_flow_rate_verifications_by_site <- function(param, bdate, edate, state, county, site) {
	getAQS("qaFlowRateVerifications/bySite", param = param, bdate = bdate, edate = edate, state = state, county = county, site = site, auth = TRUE)
}

#'@rdname qa_flow_rate_verifications
#'@export
qa_flow_rate_verifications_by_county <- function(param, bdate, edate, state, county) {
	getAQS("qaFlowRateVerifications/byCounty", param = param, bdate = bdate, edate = edate, state = state, county = county, auth = TRUE)
}

#'@rdname qa_flow_rate_verifications
#'@export
qa_flow_rate_verifications_by_state <- function(param, bdate, edate, state) {
	getAQS("qaFlowRateVerifications/byState", param = param, bdate = bdate, edate = edate, state = state, auth = TRUE)
}

#'@rdname qa_flow_rate_verifications
#'@export
qa_flow_rate_verifications_by_pqao <- function(param, bdate, edate, pqao) {
	getAQS("qaFlowRateVerifications/byPQAO", param = param, bdate = bdate, edate = edate, pqao = pqao, auth = TRUE)
}

#'@rdname qa_flow_rate_verifications
#'@export
qa_flow_rate_verifications_by_ma <- function(param, bdate, edate, ma) {
	getAQS("qaFlowRateVerifications/byMA", param = param, bdate = bdate, edate = edate, ma = ma, auth = TRUE)
}
