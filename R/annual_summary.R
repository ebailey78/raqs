...
#'@rdname annual_summary
#'@export
annual_data_by_site <- function(param, bdate, edate, state, county, site, cbdate, cedate) {
	getAQS("annualData/bySite", param = param, bdate = bdate, edate = edate, state = state, county = county, site = site, cbdate = cbdate, cedate = cedate, auth = TRUE)
}

#'@rdname annual_summary
#'@export
annual_data_by_county <- function(param, bdate, edate, state, county, cbdate, cedate) {
	getAQS("annualData/byCounty", param = param, bdate = bdate, edate = edate, state = state, county = county, cbdate = cbdate, cedate = cedate, auth = TRUE)
}

#'@rdname annual_summary
#'@export
annual_data_by_state <- function(param, bdate, edate, state, cbdate, cedate) {
	getAQS("annualData/byState", param = param, bdate = bdate, edate = edate, state = state, cbdate = cbdate, cedate = cedate, auth = TRUE)
}

#'@rdname annual_summary
#'@export
annual_data_by_box <- function(param, bdate, edate, minlat, maxlat, minlon, maxlon, cbdate, cedate) {
	getAQS("annualData/byBox", param = param, bdate = bdate, edate = edate, minlat = minlat, maxlat = maxlat, minlon = minlon, maxlon = maxlon, cbdate = cbdate, cedate = cedate, auth = TRUE)
}

#'@rdname annual_summary
#'@export
annual_data_by_cbsa <- function(param, bdate, edate, cbsa, cbdate, cedate) {
	getAQS("annualData/byCBSA", param = param, bdate = bdate, edate = edate, cbsa = cbsa, cbdate = cbdate, cedate = cedate, auth = TRUE)
}
